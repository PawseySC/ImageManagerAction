...
# =========================
ARG PY_VER=3.11
ARG PENNYLANE_VERSION=v0.45.0
ARG LIGHTNING_VERSION=v0.45.0
...
LABEL org.opencontainers.image.authors="Shusen Liu"
LABEL org.opencontainers.image.name="python${PY_VER}-pennylane${PENNYLANE_VERSION}-lighning${LIGHTNING_VERSION}"
